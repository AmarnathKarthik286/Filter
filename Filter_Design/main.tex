...
\author{Yakkala Amarnath Karthik \\EE23BTECH11066\\ e-mail: ee23btech11066@iith.ac.in	}
...
\begin{align}
    \Omega_{Ls1} &= \frac{\Omega_{s1}^2 - \Omega_0^2}{B\Omega_{s1}} = -1.5133\\
    \Omega_{Ls2} &= \frac{\Omega_{s2}^2 - \Omega_0^2}{B\Omega_{s2}} = 1.4949
\end{align}
And we choose the minimum of these two stopband edges
\begin{align}
    \Omega_{Ls} = \mbox{min}(\vert \Omega_{Ls_1}\vert,\vert \Omega_{Ls_2}\vert) = 1.4949
\end{align}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/pole_zero_plt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
Plot fot Figure 3
\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/plot2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/plot3.py
\end{lstlisting}
\end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figs/Digital_BPF.png}
    \caption{Digital Band Pass filter obtained from equation 45}
\end{figure}

\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/H_dbp.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/FIR_1.py
\end{lstlisting}
...
\end{figure}
\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/plot4.py
\end{lstlisting}
...
\end{figure}
\begin{lstlisting}
https://github.com/AmarnathKarthik286/Filter/blob/main/Filter_Design/codes/plot5.py
\end{lstlisting}
